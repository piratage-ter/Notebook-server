...
c.NotebookApp.tornado_settings = {
     'headers': {
        'Content-Security-Policy': "frame-ancestors https://192.168.33.56:8050/ 'self' "
    }
}
...
#  Choices: any of ['blake2s', 'blake2b', 'sha3_224', 'sha384', 'sha512', 'sha3_512', 'sha3_256', 'sha3_384', 'sha256', 'md5', 'sha224', 'sha1']
#  Default: 'sha256'
